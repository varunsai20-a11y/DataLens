...
CREATE INDEX IF NOT EXISTS idx_dataset_versions_version_number ON dataset_versions(version_number);
CREATE UNIQUE INDEX IF NOT EXISTS idx_dataset_versions_dataset_id_version ON dataset_versions(dataset_id, version_number);

CREATE INDEX IF NOT EXISTS idx_analysis_jobs_dataset_version_id ON analysis_jobs(dataset_version_id);
CREATE INDEX IF NOT EXISTS idx_analysis_jobs_status ON analysis_jobs(status);
CREATE INDEX IF NOT EXISTS idx_analysis_jobs_status_updated_at ON analysis_jobs(status, updated_at);
